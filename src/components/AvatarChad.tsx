...
export default function AvatarChad({ size = 120, className = '' }: Props) {
  return (
    <svg
      ...
      width={size}
      height={size * (160 / 120)}
      className={`avatar-chad ${className}`}
      aria-label="Chad Persona"
      role="img"
    >
      {/* Body: Patagonia vest over hoodie */}
      <g className="chad-body">
